$(document).ready(function(){
	...
	//결제 관리
    $(".mj3-1").find(".nav > ul > li:nth-child(3)").addClass("active").children("li:nth-child(1)").addClass("active");
    ...
    $(".mj3-1.detail").find(".nav > ul > li:nth-child(3)").addClass("active").children("li:nth-child(1)").addClass("active");
    ...
    $(".mj3-2").find(".nav > ul > li:nth-child(3)").addClass("active").children("li:nth-child(2)").addClass("active");
    $(".mj3-2").find(".top").children(".location").children(".menu1").text("결제 통계").next().hide();

    $(".mj3-3").find(".nav > ul > li:nth-child(3)").addClass("active").children("li:nth-child(1)").addClass("active");
    $(".mj3-3").find(".top").children(".location").children(".menu1").text("판매점 등록").next().hide();

	//유료 API 관리
    $(".mj4-1").find(".nav > ul > li:nth-child(4)").addClass("active").children("li:nth-child(1)").addClass("active");

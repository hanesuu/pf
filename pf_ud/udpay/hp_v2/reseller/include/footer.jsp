        ...
        <div class="ft-row-2">
            ...
            <address>
                ...
                <p>
                    ...
                    <span><strong>고객센터</strong>1800-3925</span>
            ...
            <p class="copyright">
                Copyright &copy; 2020 UDID Inc. All rights reserved. <br class="desktop-hidden-sm" /> Inspired by Charlie C
            </p>
        </div>
        <!-- //ft-row-2 -->
    </div>
